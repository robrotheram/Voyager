                            ...
                            <ul className="nav navbar-nav float-lg-right">
                                <li className="nav-item">
                                    <form className="form-inline waves-effect waves-light time-form">
                                        <a className="btn btn-primary waves-effect waves-light"><i className="fa fa-angle-left"></i></a>
                                        ...
                                        <a className="btn btn-primary waves-effect waves-light"><i className="fa fa-angle-right"></i></a>
                                    </form>
                                </li>
                            </ul>
                        </ul>
